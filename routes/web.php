...
Route::get('/profil', [LandingController::class, 'showProfil'])->name('profil');
Route::get('/hubungi-kami', [LandingController::class, 'showKontak'])->name('kontak');
Route::get('/prm', [LandingController::class, 'showPrm'])->name('prm');

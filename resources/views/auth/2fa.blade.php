...
<body class="min-h-screen flex items-center justify-center px-4 py-12 font-sans">
    ...
    <div class="w-full max-w-sm">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-secondary/20 px-8 py-10">
            ...
            <div class="flex flex-col items-center text-center mb-8">
                <div class="w-14 h-14 bg-primary/5 border border-primary/10 rounded-2xl flex items-center justify-center mb-4">
                    <svg class="w-7 h-7 text-primary" fill="none" stroke="currentColor" stroke-width="1.75" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M10.5 1.5H8.25A2.25 2.25 0 006 3.75v16.5a2.25 2.25 0 002.25 2.25h7.5A2.25 2.25 0 0018 20.25V3.75a2.25 2.25 0 00-2.25-2.25H13.5m-3 0V3h3V1.5m-3 0h3m-3 0h3m-3 8.25h3m-3 3.75h3m-3 3.75h3"/>
                    </svg>
                </div>
                <h1 class="text-xl font-bold text-gray-900">Verifikasi Dua Faktor</h1>
            ...
            {{-- Info box --}}
            <div class="flex items-start gap-3 bg-primary/5 border border-primary/10 rounded-xl px-4 py-3 mb-6">
                ...
                <p class="text-xs text-primary/95 leading-relaxed">
                    Kode berlaku selama <strong class="font-semibold text-primary">30 detik</strong>.
            ...
            <form method="POST" action="{{ route('bendahara.2fa.check') }}">
                ...
                <label for="otp" class="block text-xs font-semibold text-gray-600 mb-2">
                    Kode OTP
                </label>
                ...
                <button
                    type="submit"
                    class="w-full h-11 bg-primary hover:bg-primary-light active:scale-[.98]
            ...
            <div class="mt-5 text-center">
                <a
                    ...
                    class="text-xs text-gray-400 hover:text-primary transition-colors font-semibold"
                >
        ...
        <p class="text-center text-xs text-gray-400 mt-6">
            ...
            <span class="text-primary font-semibold">Sistem Bendahara</span>
        </p>

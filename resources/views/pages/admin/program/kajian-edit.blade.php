<x-app-layout>
    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <h2 class="text-xl font-bold text-gray-900" style="font-family:'DM Sans',sans-serif">Edit Jadwal Kajian</h2>
            </div>
    ...
    <style>
        ...
        /* Tombol hapus confirm state */
        .btn-destroy { transition: all .2s ease; }
        .btn-destroy.confirming {
    ...
    <div class="min-h-screen bg-[#FAFAFA] dm py-10 px-4">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="flex items-center justify-between mb-8">
                <p class="text-sm text-gray-500">Edit field yang diperlukan lalu simpan.</p>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
                ...
                <div>
                    ...
                    <form action="{{ route('admin.jadwal-kajian.update', $jadwal->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="space-y-4">
                                ...
                                <div class="flex items-start gap-4">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <textarea name="deskripsi" rows="4"
                                            placeholder="Deskripsi singkat kegiatan kajian..."
                                            class="field-input text-base text-gray-900 border-none py-1"
                                            oninput="sync('preview-deskripsi', this.value, 'Deskripsi kegiatan akan tampil di sini...')">{{ old('deskripsi', $jadwal->deskripsi) }}</textarea>
                                        @error('deskripsi')
                                            <p class="text-red-500 text-xs mt-1 font-medium">{{ $message }}</p>
                                        @enderror
                                    </div>
                        ...
                        {{-- Footer --}}
                        <div class="mt-8 pt-6 border-t border-gray-200 flex items-center justify-between gap-3 flex-wrap">
                            <div class="flex items-center gap-2">
                                {{-- Tombol Hapus dengan double-confirm --}}
                                <button type="button" id="btn-destroy"
                                    onclick="confirmDestroy()"
                                    class="btn-destroy text-sm px-4 py-2.5 rounded-xl border border-gray-200 text-gray-500 hover:border-red-200 hover:text-red-500 transition font-medium">
                                    Hapus Jadwal
                                </button>
                    ...
                    <form id="form-destroy"
                        action="{{ route('admin.jadwal-kajian.destroy', $jadwal->id) }}"
                        ...
                        <div class="p-6 space-y-5">
                            ...
                            <div class="space-y-2.5">
                                ...
                                <div class="flex items-center gap-3 text-sm text-gray-600">
                                    ...
                                    <span id="preview-tanggal" class="text-gray-600">
                                ...
                                <div class="flex items-center gap-3 text-sm text-gray-600">
                                    ...
                                    <span id="preview-waktu" class="text-gray-600">
                                ...
                                <div class="flex items-center gap-3 text-sm text-gray-600">
                                    ...
                                    <span id="preview-lokasi" class="text-gray-600">
                                        {{ $jadwal->lokasi }}
                                    </span>
                                </div>
                            ...
                            <p id="preview-deskripsi" class="text-gray-500 text-sm leading-relaxed line-clamp-3">
                                {{ $jadwal->deskripsi ?: 'Deskripsi kegiatan akan tampil di sini...' }}
                            </p>
    ...
    <script>
        ...
        // ── Double-confirm hapus ──
        let destroyConfirming = false;
        let destroyTimer = null;

        function confirmDestroy() {
            const btn = document.getElementById('btn-destroy');
            if (!destroyConfirming) {
                // State pertama: minta konfirmasi
                destroyConfirming = true;
                btn.classList.add('confirming');
                btn.textContent = 'Yakin hapus? Klik lagi';
                // Auto-reset setelah 3 detik kalau tidak diklik
                destroyTimer = setTimeout(() => {
                    resetDestroy();
                }, 3000);
            } else {
                // State kedua: eksekusi hapus
        ...
        function resetDestroy() {
            destroyConfirming = false;
            const btn = document.getElementById('btn-destroy');
            btn.classList.remove('confirming');
            btn.textContent = 'Hapus Jadwal';
        }
    </script>

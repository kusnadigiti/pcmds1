<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <h2 class="text-lg font-bold text-gray-900 dm">Edit Organisasi</h2>
            </div>
        ...
        <div class="max-w-5xl mx-auto">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start w-full">
                ...
                <div class="lg:col-span-1">
                    <form action="{{ route('admin.organisasi-otonom.update', $organisasi->id) }}" method="POST"
                            ...
                            <div class="flex items-start gap-4 relative z-10">
                                ...
                                <div class="flex-1 min-w-0 w-full">
                                    ...
                                    <input type="text" name="nama" value="{{ old('nama', $organisasi->nama) }}"
                                        maxlength="200" required placeholder="Pimpinan Cabang Aisyiyah"
                                ...
                                <div class="flex items-start gap-4 relative z-10">
                                    ...
                                    <div class="flex-1 min-w-0 w-full">
                                        ...
                                        <input type="text" name="singkatan"
                                            value="{{ old('singkatan', $organisasi->singkatan) }}" maxlength="10"
                                            required placeholder="AIS"
                                            class="field-input text-base font-semibold text-slate-900 h-12 pr-3 w-full"
                                            oninput="updateField(this.closest('.card-field'), this.value)" />
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start gap-4 relative z-10">
                                    ...
                                    <div class="flex-1 min-w-0 w-full">
                                        ...
                                        <select name="tipe" required
                                            ...
                                            <option value="otonom"
                                                {{ old('tipe', $organisasi->tipe) == 'otonom' ? 'selected' : '' }}>
                                                Otonom</option>
                                            <option value="lembaga"
                                                {{ old('tipe', $organisasi->tipe) == 'lembaga' ? 'selected' : '' }}>
                                                Lembaga</option>
                                            <option value="majelis"
                                                {{ old('tipe', $organisasi->tipe) == 'majelis' ? 'selected' : '' }}>
                                                Majelis</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start gap-4 relative z-10">
                                    ...
                                    <div class="flex-1 min-w-0 w-full">
                                        ...
                                        <input type="number" name="periode_mulai"
                                            value="{{ old('periode_mulai', $organisasi->periode_mulai) }}" required
                                ...
                                <div class="flex items-start gap-4 relative z-10">
                                    ...
                                    <div class="flex-1 min-w-0 w-full">
                                        ...
                                        <input type="number" name="periode_selesai"
                                            value="{{ old('periode_selesai', $organisasi->periode_selesai) }}"
                                            required placeholder="2027" min="1900" max="2100"
                                            class="field-input text-base font-semibold text-slate-900 h-12 pr-3 w-full"
                                            oninput="updateField(this.closest('.card-field'), this.value)" />
                            ...
                            <div class="flex items-start gap-4 relative z-10">
                                ...
                                <div class="flex-1 min-w-0 w-full">
                                    ...
                                    <textarea name="deskripsi" rows="3" placeholder="Deskripsi singkat tentang organisasi ini..."
                                        ...
                                        oninput="updateField(this.closest('.card-field'), this.value)">{{ old('deskripsi', $organisasi->deskripsi) }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div class="flex items-start gap-4 relative z-10">
                                ...
                                <div class="flex-1 min-w-0 w-full">
                                    ...
                                    @if ($organisasi->logo)
                                        <div class="mb-3">
                                            <img src="{{ asset('storage/' . $organisasi->logo) }}" alt="Current Logo"
                                    ...
                                    <p class="text-xs text-slate-400 mt-1">Format: png, jpg, webp | Max: 2MB. Kosongkan
                            ...
                            <div class="flex items-center justify-between relative z-10">
                                ...
                                <label class="relative z-20 inline-flex items-center cursor-pointer group">
                                    ...
                                    <input type="checkbox" id="status-toggle" name="is_active" value="1"
                                        {{ old('is_active', $organisasi->is_active) ? 'checked' : '' }}
    ...
    <!-- SCRIPT SAMA PERSIS SEPERTI DI CREATE -->
    <script>

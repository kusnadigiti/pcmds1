    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <h2 class="text-xl font-bold text-gray-900" style="font-family:'DM Sans',sans-serif">Hero Section</h2>
            </div>
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <div class="drop-zone relative flex flex-col items-center justify-center py-8 px-4 text-center" id="drop-zone">
                                            ...
                                            <div id="drop-placeholder">
                                                ...
                                                <p class="text-sm text-gray-400 font-medium">Klik atau drag gambar ke sini</p>
                                ...
                                <div class="flex items-start gap-4">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <textarea name="description" rows="4"
                                            placeholder="Contohhh.. Menjadi pilar dakwah"
                                            class="field-input text-base text-gray-900 border-none py-1"
                                            oninput="syncDescription(this.value)">{{ old('description') }}</textarea>
                                        @error('description')
                                            <p class="text-red-500 text-xs mt-1 font-medium">{{ $message }}</p>
                                        @enderror
                                    </div>
                ...
                <div class="preview-panel au d2">
                    ...
                    <div class="bg-white border border-gray-200 rounded-3xl overflow-hidden shadow-sm p-4">
                        ...
                        <div class="hero-preview-card mb-4">
                            <img id="preview-banner-img" src="" alt="Banner Preview" class="hidden">
                            <div id="preview-banner-placeholder" class="absolute inset-0 flex items-center justify-center">
                            ...
                            <div class="hero-preview-overlay">
                                <p id="preview-tagline" class="text-xs font-semibold text-white/70 uppercase tracking-widest mb-1 hidden"></p>
                                <h3 id="preview-title" class="text-white text-lg font-bold leading-tight">Judul Hero Section</h3>
                                <p id="preview-desc" class="text-white/60 text-xs mt-1 line-clamp-2 hidden"></p>
                            </div>
                        </div>
                        ...
                        <div class="space-y-2">
                            <div class="flex items-center gap-3 p-3 rounded-xl bg-gray-50">
                                ...
                                <div class="min-w-0">
                                    ...
                                    <p id="preview-tagline-meta" class="text-sm text-gray-700 font-medium truncate">—</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center gap-3 p-3 rounded-xl bg-gray-50">
                                ...
                                <div class="min-w-0">
                                    ...
                                    <p id="preview-title-meta" class="text-sm text-gray-700 font-medium truncate">—</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start gap-3 p-3 rounded-xl bg-gray-50">
                                ...
                                <div class="min-w-0 flex-1">
                                    ...
                                    <p id="preview-desc-meta" class="text-sm text-gray-700 font-medium line-clamp-3">—</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        function updateCompletion() {
            ...
            cards.forEach(card => {
                ...
                // Only count title as required (image, tagline, description are optional)
                const isRequired = input && (input.name === 'title');

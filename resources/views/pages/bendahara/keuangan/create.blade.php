<x-app-layout>
    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <h2 class="text-xl font-bold text-gray-900" style="font-family:'DM Sans',sans-serif">Tambah Laporan</h2>
            </div>
        </div>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
                ...
                <div>
                    ...
                    <form action="{{ route('bendahara.keuangan.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="space-y-4">
                                ...
                                <div class="flex items-start gap-4">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <textarea name="deskripsi" rows="4"
                                            ...
                                            oninput="sync('preview-deskripsi', this.value, 'Deskripsi laporan akan tampil di sini...')">{{ old('deskripsi') }}</textarea>
                                        @error('deskripsi')
                                            <p class="text-red-500 text-xs mt-1 font-medium">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <div id="kategori-dropdown" class="hidden mt-2 border rounded-xl overflow-hidden bg-white shadow-lg z-10">
                                            <div class="kategori-opt px-3 py-2.5 flex items-center gap-2 hover:bg-gray-50 cursor-pointer"
                                                data-value="pemasukan" data-label="Pemasukan" data-color="bg-emerald-500" data-dot="bg-emerald-500">
                                                <span class="w-2 h-2 rounded-full bg-emerald-500"></span>
                                                <span class="text-sm font-medium">Pemasukan</span>
                                            </div>
                                            <div class="kategori-opt px-3 py-2.5 flex items-center gap-2 hover:bg-gray-50 cursor-pointer"
                                                data-value="pengeluaran" data-label="Pengeluaran" data-color="bg-red-500" data-dot="bg-red-500">
                            ...
                            <div class="au d5">
                                <div class="flex items-center justify-between mb-2 px-1">
                                    ...
                                    <span class="text-xs text-gray-400">Wajib · Maks 5MB</span>
                                </div>
                                <label for="file-input" id="upload-zone"
                                    ...
                                    <div id="file-placeholder">
                                        ...
                                        <p class="font-semibold text-gray-900 text-sm mb-0.5">Upload file PDF laporan</p>
                    ...
                    <div class="bg-white border border-gray-200 rounded-3xl overflow-hidden shadow-sm">
                        <div class="p-6 space-y-4">
                            ...
                            <div>
                                ...
                                <h3 id="preview-judul" class="text-lg font-semibold text-gray-900 leading-snug">Judul Laporan</h3>
                            </div>

                            {{-- Deskripsi --}}
                            <div>
                                <p class="text-xs text-gray-400 font-medium mb-1">Deskripsi</p>
                                <p id="preview-deskripsi" class="text-sm text-gray-500 line-clamp-3">Deskripsi laporan akan tampil di sini...</p>
                            </div>
                            ...
                            <div class="border-t border-gray-100 pt-4 space-y-2">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="min-w-0">
                                        ...
                                        <p id="preview-file" class="text-sm font-medium text-gray-400 italic">Belum dipilih</p>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        // ── Completion ring ────────────────────────────────────────
        // Required: judul, kategori, tanggal_laporan, file
        // Optional: deskripsi
        const CIRC = 50.27;
        ...
        function updateCompletion() {
            const checks = [
                ...
                !!document.querySelector('input[name="file"]')?.files?.length,
            ];

            // filled-badge per card-field (excluding deskripsi which is optional)

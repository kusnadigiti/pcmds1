...
<footer id="footer" class="bg-gradient-to-b from-accent-green to-accent text-white/65 pt-16 relative overflow-hidden">
    ...
    <div class="absolute -top-[80px] -right-[80px] w-[300px] h-[300px] rounded-full border border-secondary/10 pointer-events-none"></div>
    <div class="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
                <div class="flex items-center gap-3 mb-4">
                    <div class="relative">
                        <div class="absolute -inset-0.5 rounded-full bg-gradient-to-br from-secondary to-primary opacity-60"></div>
            ...
            <div>
                ...
                <ul class="list-none p-0 m-0 flex flex-col gap-2">
                    <li><a href="#profil" class="text-white/45 hover:text-secondary text-xs no-underline transition duration-200">✦ Profil Organisasi</a></li>
                    <li><a href="#artikel" class="text-white/45 hover:text-secondary text-xs no-underline transition duration-200">✦ Artikel</a></li>
                    <li><a href="#berita" class="text-white/45 hover:text-secondary text-xs no-underline transition duration-200">✦ Berita</a></li>
                    <li><a href="#program" class="text-white/45 hover:text-secondary text-xs no-underline transition duration-200">✦ Program</a></li>
                    <li><a href="#organisasi" class="text-white/45 hover:text-secondary text-xs no-underline transition duration-200">✦ Organisasi Otonom</a></li>
                    <li><a href="#amal-usaha" class="text-white/45 hover:text-secondary text-xs no-underline transition duration-200">✦ Amal Usaha</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <div class="flex flex-col gap-3">
                    ...
                    <div class="flex gap-2.5 items-center">
                        <span class="text-secondary text-sm">✉️</span>
                        <p class="text-xs text-white/45 m-0">{{ $email }}</p>
                    </div>
                    <div class="flex gap-2.5 items-center">
                        <span class="text-secondary text-sm">🕐</span>
                        <p class="text-xs text-white/45 m-0">{{ $daysStart }} – {{ $daysEnd }}, {{ $hoursStart }} – {{ $hoursEnd }} WIB</p>
                    </div>
                </div>
            </div>
        ...
        <!-- FOOTER BOTTOM -->
        <div class="border-t border-secondary/15 mt-10 py-5 flex flex-col gap-2 justify-between items-center text-[11px] text-white/30 md:flex-row">
            <p class="m-0">© {{ date('Y') }} PCM Duren Sawit 1. All rights reserved.</p>
            <div class="flex flex-wrap justify-center gap-3">
                <a href="#" class="text-white/30 hover:text-secondary no-underline transition duration-200">Kebijakan Privasi</a>
                <a href="#" class="text-white/30 hover:text-secondary no-underline transition duration-200">Syarat & Ketentuan</a>

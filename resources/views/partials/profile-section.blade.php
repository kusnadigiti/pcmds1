...
<div class="bg-cream py-20 relative overflow-hidden">
    {{-- Background pattern --}}
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
            ...
            <div class="relative">
                <div
                    class="absolute -inset-1.5 rounded-[2rem] bg-gradient-to-br from-secondary to-primary opacity-35 z-0">
                </div>
                ...
                <!-- floating card -->
                <div
                    class="absolute bottom-6 -right-4 bg-white py-4 px-5 rounded-2xl shadow-xl shadow-black/10 border-l-4 border-primary z-20 min-w-[140px]">
                ...
                <!-- decorative dot grid -->
                <div
                    class="absolute -top-5 -left-5 w-20 h-20 bg-[radial-gradient(circle,_#D4A017_1.5px,_transparent_1.5px)] bg-[size:12px_12px] opacity-50 z-0">
                </div>
            </div>
            ...
            <div>
                ...
                <h1
                    class="text-3xl sm:text-4xl lg:text-5xl font-extrabold leading-tight text-gray-900 mb-5 tracking-tight">
                ...
                <div class="flex flex-col gap-3">
                    ...
                    <div class="border border-primary/15 rounded-2xl overflow-hidden bg-white shadow-sm shadow-black/5">
                        <button onclick="toggleAcc('visi')"
                            ...
                            <span class="flex items-center gap-2.5">
                                <span
                                    class="w-8 h-8 rounded-lg bg-primary/8 flex items-center justify-center">
                                    <i data-lucide="eye" class="w-4 h-4 text-primary"></i>
                                </span>
                                Visi Persyarikatan
                            </span>
                            <span id="icon-visi"
                                class="text-primary text-xl transition-transform duration-300 font-light">+</span>
                        </button>
                        <div id="visi"
                            class="max-h-0 opacity-0 overflow-hidden transition-all duration-500 ease-in-out px-5">
                                    ...
                                    @foreach ($misiPoints as $point)
                                        @if (trim($point))
                                            <div class="flex items-start gap-2">
                                                <i data-lucide="sparkles" class="w-3.5 h-3.5 text-secondary mt-0.5 shrink-0"></i>
                    ...
                    <div class="border border-primary/15 rounded-2xl overflow-hidden bg-white shadow-sm shadow-black/5">
                        <button onclick="toggleAcc('pengurus')"
                            ...
                            <span class="flex items-center gap-2.5">
                                <span
                                    class="w-8 h-8 rounded-lg bg-accent/6 flex items-center justify-center">
                                    <i data-lucide="landmark" class="w-4 h-4 text-primary-light"></i>
                                </span>
                                Pimpinan & Majelis
                            </span>
                        ...
                        <div id="pengurus"
                            ...
                            <div class="pb-4">
                                ...
                                <a href="/struktur-organisasi"
                                    ...
                                    Lihat Struktur Organisasi <i data-lucide="arrow-right" class="w-4 h-4 inline-block align-middle ml-1"></i>
                                </a>
                            </div>
                        </div>
                    </div>

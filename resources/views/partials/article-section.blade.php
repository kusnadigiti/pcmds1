...
<section id="artikel" class="bg-gradient-to-b from-accent-green to-accent py-20 relative overflow-hidden">
    ...
    <div class="absolute -top-[100px] -right-[100px] w-[400px] h-[400px] rounded-full border border-secondary/10 pointer-events-none"></div>
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="mb-14">
                <div class="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
                    <div>
                        <span class="inline-flex items-center gap-2 bg-secondary/10 border border-secondary/35 text-secondary text-[11px] font-bold tracking-wider uppercase py-1 px-4 rounded-full mb-4">✦ Wawasan Islam</span>
                    ...
                    <div class="max-w-md">
                        <p class="text-white/60 text-sm leading-relaxed mb-2">
                            Berbagai artikel, pembelajaran, dan nilai-nilai Islami yang kami bagikan sebagai sumber inspirasi dan penguatan iman
                        </p>
                ...
                <div class="flex flex-col gap-4">
                    @foreach ($articles->take(3) as $article)
                        <a href="{{ route('articles.show', $article->slug) }}" class="group block no-underline">
                            <div class="bg-white/5 border border-secondary/15 rounded-2xl overflow-hidden grid lg:grid-cols-12 transition-all duration-300 hover:bg-white/10 hover:border-secondary/35 hover:-translate-y-1">
                                ...
                                <div class="p-7 flex flex-col justify-center gap-3 lg:col-span-8">
                                    ...
                                    <h3 class="text-xl font-bold text-white leading-snug m-0 transition-colors duration-200 group-hover:text-secondary">
                                        {{ $article->title }}
                                    </h3>
